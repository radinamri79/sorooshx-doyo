...
const footerLinks = {
  discover: [
    ...
    { label: "Popular Projects", href: "/services/popular" },
  ],
  company: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
              <Image
                ...
                className="w-9 h-9"
              />
              <span className="font-bold text-[22px] text-white tracking-tight">doyo</span>
            </Link>
            <p className="text-sm leading-relaxed text-gray-500 max-w-xs mb-6">
              Book trusted help for home tasks. Find skilled taskers in your neighborhood and get things done.
            </p>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-navy-800 hover:bg-navy-700 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-navy-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Doyo. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">
            Made with care for your home tasks.
          </p>
        </div>
      </div>
    </footer>
