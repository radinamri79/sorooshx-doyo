...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="doyo"),
        "USER": config("DB_USER", default="doyo"),
        "PASSWORD": config("DB_PASSWORD", default="doyo"),
...
REST_AUTH = {
    "USE_JWT": True,
    "JWT_AUTH_COOKIE": "doyo-auth",
    "JWT_AUTH_REFRESH_COOKIE": "doyo-refresh",
